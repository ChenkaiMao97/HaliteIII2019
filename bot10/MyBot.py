...
RETURN_COEFF = 0.80  # above which percentage of MAX_HALITE we return
...
while True:
    ...
    for ship in me.get_ships():
        ...
        # then status is heading
            ...
            ship_status[ship.id] = "returning"
            ship.destination = thisDropOff.position
        elif game_map.calculate_distance(ship.position,thisDropOff.position)>(constants.MAX_TURNS-game.turn_number)-25:
